...
public class PathAcceptanceSteps2 {
  private PathAcceptanceSteps2() {}

  public static ExtractableResponse<Response> 경로_조회_요청2(
      Station source, Station target, String accessToken) {
    PathRequest2 request = PathRequest2.of(source.getId(), target.getId(), PathType2.DISTANCE);
  ...
  public static void 경로_역_목록_조회됨2(ExtractableResponse<Response> response, String... expectedNames) {
  ...
  public static void 경로_거리_조회됨2(ExtractableResponse<Response> response, int expectedDistance) {
